...
/**
 * REST controller for managing {@link com.jawnz.app.domain.Tag}.
 */
@RestController
@RequestMapping("/api")
public class TagResource {
    ...
    private static final String ENTITY_NAME = "jawnzappTag";
    ...
    public ResponseEntity<Tag> updateTag(@Valid @RequestBody Tag tag) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, tag.getId()))
            .body(result);
    }
